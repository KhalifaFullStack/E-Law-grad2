...
<body style="background-image: linear-gradient(rgba(0,0,0,0.5) , rgba(0,0,0,0.5)), url(pics/main/header-main1.jfif ); background-size: cover; background-repeat: no-repeat;">
    ...
    <div class="container signup">
        <div class="title">Lawyer Registration</div>
        <div class="content">
            <form action="sign-up-lawyer.php" method="post">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="Lawyer_ID" placeholder="Enter your ID" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="License_No" placeholder="Enter your License" required>
                    </div>
                    <div class="input-box">
                        <span class="details">License Expiry Date</span>
                        <input type="month" name="License_expiryDate" min="2023-01" placeholder="Enter Expiry Date" value="01-2023" required>
                    </div>
                    <div class="input-box">
        ...
        <div style="display: none;">
            ...
            $License_expiryDate = $_REQUEST["License_expiryDate"];
        ...
        <div style="color: transparent;">
            ...
            if (strlen($Lawyer_ID) != 14 || strlen($Lawyer_ID) == 0) {
                ...
                $statement = "insert into `lawyer`
                (`Lawyer_ID` , `Password` , `FullName` ,  `Specialization` ,   `Phone_No` ,  `Gender` , `Email` , `License_No` , `License_expiryDate`)values
                ('$Lawyer_ID' , '$Password' , '$FullName' , '$Specialization' , '$Phone_No' , '$Gender' , '$Email' , '$License_No' , '$License_expiryDate')";
                ...
                if ($result == true) {
                    echo "<b style=color:whitesmoke; text-align:center; >Lawyer was added Successfully! You can sign in now </b> <br>";
                } elseif ($result == false) {
                    echo "<b style=color:whitesmoke; text-align:center; >Failed to add Lawyer! Please contact us for help </b><br>";
                }
            }
            ?>
        </div>
