...
<body style="background-image: linear-gradient(rgba(0,0,0,0.5) , rgba(0,0,0,0.5)), url(pics/main/header-main1.jfif ); background-size: cover; background-repeat: no-repeat;">
    ...
    <div class="container signup">
        ...
        <div class="content">
            <form action="sign-up-citizen.php" method="post">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="Citizen_ID" placeholder="Enter your Identification number" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <span class="details">Identification Type</span>
                        <input type="text" name="ID_Type" placeholder="Enter your ID Type" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <span class="details">Residentional location</span>
                        <input type="text" name="Residitioanl_loc" placeholder="Enter your location" required>
                    </div>
        ...
        <div style="display: none;">
            ...
            $Age = $_REQUEST["Age"];
            $Residitioanl_loc = $_REQUEST["Residitioanl_loc"];
        ...
        <div style="color: transparent;">
            ...
            if ($x == 1) {
                ...
                $statement = "insert into `citizen`
                (`Citizen_ID` , `Password` , `ID_Type` ,  `Name` ,   `Age` ,  `Gender` , `Residitioanl_loc` , `Email`)values
                ('$Citizen_ID' , '$Password' , '$ID_Type' , '$Name' , '$Age' , '$Gender' , '$Residitioanl_loc' , '$Email')";
                ...
                if ($result == true) {
                    echo "<b style=color:whitesmoke; text-align:center; >Citizen was added Successfully! You can sign in now </b> <br>";
                } elseif ($result == false) {
                    echo "<b style=color:whitesmoke; text-align:center; >Failed to add citizen! Please contact us for help </b><br>";
                }
            }
            ?>
        </div>
